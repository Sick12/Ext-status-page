Ext.define('statusPage.store.ComponentStore', {
	extend: 'Ext.data.Store',
	alias: 'store.componentStore',
	//requires: ['statusPage.view.status.ComponentStatusModel'],
        //model: 'statusPage.view.status.componentStatusModel',
